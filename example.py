...
data = sio.loadmat('SMK-CAN-187.mat')
x_train = data['X']
y_train = data['Y']
...
rank_di = DI.di(x_train, y_train, num_features, type_Y, epsilon, mu, learning_rate = 0.1, iterations = 500, verbose = True)
